...
public class WorkEffortAssocAttribute {
    ...
    @JoinedBy("workEffortIdFrom=WorkEffortAssoc.workEffortIdFrom, workEffortIdTo=WorkEffortAssoc.workEffortIdTo, workEffortAssocTypeId=WorkEffortAssoc.workEffortAssocTypeId, fromDate=WorkEffortAssoc.fromDate")
    @ToString.Exclude
