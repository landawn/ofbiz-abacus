...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "gl_account_and_history_totals")
public class GlAccountAndHistoryTotals {
    @ReadOnly
    @Column(name = "total_posted_debits")
    private String totalPostedDebits;

    @ReadOnly
    @Column(name = "total_posted_credits")
    private String totalPostedCredits;

    @ReadOnly
    @Column(name = "total_ending_balance")
