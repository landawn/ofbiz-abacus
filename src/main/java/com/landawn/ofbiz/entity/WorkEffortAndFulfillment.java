...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "work_effort_and_fulfillment")
public class WorkEffortAndFulfillment {
    @ReadOnly
    @Column(name = "work_effort_description")
    private String workEffortDescription;

    @ReadOnly
    @Column(name = "work_effort_fixed_asset_id")
    private String workEffortFixedAssetId;

    @ReadOnly
    @Column(name = "work_effort_facility_id")
    private String workEffortFacilityId;

    @ReadOnly
    @Column(name = "requirement_facility_id")
    private String requirementFacilityId;

    @ReadOnly
    @Column(name = "requirement_fixed_asset_id")
    ...
    @ReadOnly
    @Column(name = "requirement_creation_date")
    private String requirementCreationDate;
