...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "user_login_and_permission")
public class UserLoginAndPermission {
    @ReadOnly
    @Column(name = "permission_id")
    private String permissionId;

    @ReadOnly
    @Column(name = "permission_from_date")
    private String permissionFromDate;

    @ReadOnly
    @Column(name = "permission_thru_date")
    private String permissionThruDate;
