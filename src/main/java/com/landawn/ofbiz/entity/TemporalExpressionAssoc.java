...
public class TemporalExpressionAssoc {
    ...
    @JoinedBy("fromTempExprId=TemporalExpression.tempExprId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private TemporalExpression fromTempExpr;

    @JoinedBy("toTempExprId=TemporalExpression.tempExprId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private TemporalExpression toTempExpr;
}
