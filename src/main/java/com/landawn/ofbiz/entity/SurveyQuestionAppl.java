...
public class SurveyQuestionAppl {
    ...
    @JoinedBy("surveyQuestionId=SurveyQuestion.surveyQuestionId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private SurveyQuestion surveyQuestion;

    @JoinedBy("withSurveyQuestionId=SurveyQuestionOption.surveyQuestionId, withSurveyOptionSeqId=SurveyQuestionOption.surveyOptionSeqId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
