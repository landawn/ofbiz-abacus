 ...
 * Re-run the script if the OFBiz service definition for updateWorkEffort changes.
 */
...
/**
 * Request DTO for the updateWorkEffort service.
...
public class UpdateWorkEffortRequest extends RequestBase {
