 ...
 * Re-run the script if the OFBiz service definition for updateProductStore changes.
 */
...
/**
 * Request DTO for the updateProductStore service.
...
public class UpdateProductStoreRequest extends RequestBase {
