 ...
 * Re-run the script if the OFBiz service definition for createProductInCategory changes.
 */
...
/**
 * Request DTO for the createProductInCategory service.
...
public class CreateProductInCategoryRequest extends RequestBase {
    ...
    private Map<String, Object> productFeatureIdByType;
    private Map<String, Object> productFeatureSelectableByType;
