...
public class OrderItem {
    ...
    @JoinedBy("orderItemTypeId=OrderItemType.orderItemTypeId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private OrderItemType orderItemType;

    @JoinedBy("orderId=OrderItemGroup.orderId, orderItemGroupSeqId=OrderItemGroup.orderItemGroupSeqId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    ...
    @JoinedBy("fromInventoryItemId=InventoryItem.inventoryItemId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private InventoryItem inventoryItem;

    @JoinedBy("recurringFreqUomId=Uom.uomId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private Uom uom;
    ...
    @JoinedBy("syncStatusId=StatusItem.statusId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private StatusItem syncStatus;

    @JoinedBy("dontCancelSetUserLogin=UserLogin.userLoginId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private UserLogin dontCancelSetUserLoginRef;

    @JoinedBy("quoteId=QuoteItem.quoteId, quoteItemSeqId=QuoteItem.quoteItemSeqId")
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    ...
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private UserLogin changeByUserLogin;
}
